...
export const projects: Project[] = [
  
  {
    ...
    sluggedUrl: "case-studies/asset-management-system"
  },
  {
    id: 1,
  ...
  {
    id: 3,
    title: "Fleet Management (Parvatiya Vahan)",
    year: "2023",
    shortDesc: "A scalable Node.js backend architected for Parvatiya Vahan to manage scheduled local tourist travel and specialized pilgrimage packages.",
    longDesc: "Developed a custom Fleet-Management solution for Parvatiya Vahan, enabling efficient scheduling and management of local tourist travel and specialized pilgrimage packages. The system was built on a scalable Node.js backend, ensuring high performance and reliability under varying loads.",
    ...
    image: "https://lh3.googleusercontent.com/aida-public/AB6AXuD5IwHiaoFWlVoobSc3cM5Y_zu1pd2jxItVthFTt5Hno_AbmlSxHFvu4k1hmjJvqDsqe46FLMC8ppEj_B4GKJaSW1a-U4Rg2l4eZ_vP1ATeHV3s3aHD4uHsOZtdb0LkifCx_IUpZdaVPiv6lX8RTMAcCu91pBdS3fo6m3J4FntihVvmd60Y5Es6mEM18beKvsWgKcCXAgjDbjMGmqG5Hf2EvRjhV_RsnJHUR4CXzKJnf4BgDHYlEJhuFCUkmpYK9cKg4hoR0NDtrNI",
      sluggedUrl: "case-studies/fleet-management"
