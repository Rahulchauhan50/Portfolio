...
export default function About() {
  return (
    <section className="py-24 md:py-32 px-6 md:px-24 bg-surface-container-low" id="about">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        >
          ...
          <div className="relative aspect-square rounded-xl overflow-hidden glass-card border border-outline-variant/20">
            <img 
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 md:p-6 rounded-lg bg-surface-container-highest/30 border border-outline-variant/10">
              <span className="text-2xl md:text-3xl font-headline font-bold text-primary">2.5+</span>
              <p className="text-[10px] md:text-xs uppercase tracking-widest text-on-surface-variant mt-2">Years Experience</p>
            </div>
            <div className="p-4 md:p-6 rounded-lg bg-surface-container-highest/30 border border-outline-variant/10">
              <span className="text-2xl md:text-3xl font-headline font-bold text-tertiary">15+</span>
              <p className="text-[10px] md:text-xs uppercase tracking-widest text-on-surface-variant mt-2">Projects Delivered</p>
            </div>
          </div>
          <div className="pt-4">
            <a 
              ...
              className="inline-flex items-center gap-3 px-6 md:px-8 py-3 md:py-4 rounded-md border border-primary/30 font-bold text-primary hover:bg-primary/10 transition-all duration-300 group text-sm md:text-base"
            >
